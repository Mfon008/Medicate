// ignore_for_file: unnecessary_null_comparison, use_build_context_synchronously, deprecated_member_use, library_prefixes, strict_top_level_inference, prefer_typing_uninitialized_variables
import 'dart:async';
import 'dart:io';
...
class HealthCareViewModel extends BaseViewModel {
  ...
  var doctorError;
  String? searchuserByHealthCare = '';
  String? searchuserByHealthCareReminder = '';
  ...
  Future<void> selectTimeFreqCustomUpdate({
    ...
    required HealthCareViewModel model,
  ...
  Future<void> buildDosageMap({HealthCareViewModel? model, int? index}) async {
                  ...
                  ? Column(
                      ...
                      children: [
                        ...
                        ...List.generate(channels.length, (index) {
                          return chooseNotChannelWidgetWithSvg(
                            context,
  ...
  Widget fallbackMedicationIcon(HealthCareViewModel model) {
    return Padding(
      padding: EdgeInsets.all(8.w),
      child: SvgPicture.asset(
        model.errorRemidnderImage(
