...
class HMOViewModel extends BaseViewModel {
  ...
  setModalFlow({HMOViewModel? model, BuildContext? context}) {
    if (linIndex == 2) {
  ...
  firstSubModalFlow({HMOViewModel? model, BuildContext? context}) => Column(
  ...
  secondSubModalFlow({HMOViewModel? model, BuildContext? context}) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Center(
        child: TextView(
        ...
        children: [
          GestureDetector(
            ...
            child: Container(
              ...
              padding: isTapped ? EdgeInsets.all(3.0.w) : EdgeInsets.all(8.w),
              decoration: BoxDecoration(
  ...
  thirdSubModalFlow({HMOViewModel? model, BuildContext? context}) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Center(
        child: TextView(
