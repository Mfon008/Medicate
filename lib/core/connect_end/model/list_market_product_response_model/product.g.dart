...
Product _$ProductFromJson(Map<String, dynamic> json) => Product(
  ...
  volumePricing: json['volumePricing'],
  ...
  enlistedPricePerUnit: (json['enlistedPricePerUnit'] as num?)?.toDouble(),
  displayPricePerUnit: (json['displayPricePerUnit'] as num?)?.toDouble(),
