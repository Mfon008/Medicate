...
class HMORepoImpl {
  ...
  Future<GetListOfHospitalResponseModel> getListOfHospitals({
    ...
    final response = await _contract.getListOfHospitals(
      page: page,
      query: query,
    );
    return response;
  ...
  Future<dynamic> editHospitalNetwork({
    ...
    final response = await _contract.editHospitalNetwork(
  ...
  Future<dynamic> editHospital({
    ...
    final response = await _contract.editHospital(
  ...
  Future<dynamic> createPlanTier(
    ...
    final response = await _contract.createPlanTier(creatTierEntity);
    return response;
  }

  Future<dynamic> deletePlanTier(String planTierId) async {
    final response = await _contract.deletePlanTier(planTierId);
    return response;
  }
  ...
  Future<dynamic> updatePlanTier(
    ...
    final response = await _contract.updatePlanTier(
      updateTierEntity,
      planTierId,
    );
    return response;
  ...
  Future<dynamic> deleteHMOPlan(String planId) async {
    final response = await _contract.deleteHMOPlan(planId);
    return response;
  }
