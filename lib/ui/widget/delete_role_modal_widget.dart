// ignore_for_file: strict_top_level_inference, use_build_context_synchronously, deprecated_member_use
  ...
  void deleteRole(modelPharm) async {
    ...
    if (modelPharm.vdelete != null && modelPharm.vdelete['statusCode'] == 200) {
      ...
      await AppUtils.snackbar(
        parentContext,
        message: modelPharm.vdeleteErrorMessage,
        error: true,
      );
      onFailed();
    }
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 12.h),
                      TextView(
                        text: 'Are you sure you want to make delete this role?',
