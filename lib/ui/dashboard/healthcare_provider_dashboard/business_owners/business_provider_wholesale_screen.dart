...
class BusinessProviderWholesaleScreen extends StatefulWidget {
  const BusinessProviderWholesaleScreen({super.key});

  @override
  State<BusinessProviderWholesaleScreen> createState() =>
      _BusinessProviderWholesaleScreenState();
}

class _BusinessProviderWholesaleScreenState
    extends State<BusinessProviderWholesaleScreen> {
  int currentPage = 0;
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                TextView(
                                  text:
                                      '${m.productName?.capitalize() ?? ''} (Carton of ${m.packSize} packs)',
                                  textStyle: TextStyle(
                                    fontFamily: 'DMSans',
                                    fontSize: 17.20.sp,
                                    fontWeight: FontWeight.w500,
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    TextView(
                                      text: '${m.minimumOrderQuantity} cartons',
                                      textStyle: TextStyle(
                                        fontFamily: 'DMSans',
                                        fontSize: 14.20.sp,
                                        fontWeight: FontWeight.w500,
                                ...
                                Row(
                                  ...
                                  children: [
                                    TextView(
                                      text: formatNaira(m.displayPricePerUnit!*m.minimumOrderQuantity!),
                                      textStyle: TextStyle(
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          IconButton(
                                            onPressed:m.minimumOrderQuantity!<m.minimumOrderQuantity!?(){}: () {
                                              m.minimumOrderQuantity = m.minimumOrderQuantity!-1;
