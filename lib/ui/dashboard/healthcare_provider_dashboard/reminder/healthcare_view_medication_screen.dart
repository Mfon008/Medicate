...
class HealthcareViewMedicationScreen extends StatelessWidget {
  HealthcareViewMedicationScreen({super.key, required this.id});
  String? id;
  var medication;
  var imageUrl;
                              ...
                              TextView(
                                text:
                                    model
                                        ...
                                        ''
                                    ? ''
                                    : '0${model.getReminderByIdModel!.data!.user?.phoneNumber?.substring(4)}',
                                textStyle: TextStyle(
                                  fontFamily: 'Arial',
                                  fontSize: 14.8.sp,
                                  fontWeight: FontWeight.w400,
