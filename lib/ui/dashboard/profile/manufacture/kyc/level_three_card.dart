...
class _LevelThreeCardState extends State<LevelThreeCard> {
  ...
  void getKycBankInfo(ManufacturerViewModel model) {
    bankNameController.text =
        model.getDistributorKycResponseModel?.data?.level3?.bankName ?? '';
    accountNameController.text =
        model.getDistributorKycResponseModel?.data?.level3?.accountName ?? '';
    accountNumberController.text =
        model.getDistributorKycResponseModel?.data?.level3?.accountNumber ?? '';
    bankBVNController.text =
        model.getDistributorKycResponseModel?.data?.level3?.bvn ?? '';
    setState(() {});
  }
