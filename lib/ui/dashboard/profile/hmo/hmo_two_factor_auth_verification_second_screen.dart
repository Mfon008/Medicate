...
class HmoTwoFactorAuthVerificationSecondScreen extends StatefulWidget {
  HmoTwoFactorAuthVerificationSecondScreen({super.key});
  String? phone;
  String? resetToken;

  @override
  State<HmoTwoFactorAuthVerificationSecondScreen> createState() =>
      _HmoTwoFactorAuthVerificationSecondScreenState();
}

class _HmoTwoFactorAuthVerificationSecondScreenState
    extends State<HmoTwoFactorAuthVerificationSecondScreen> {
