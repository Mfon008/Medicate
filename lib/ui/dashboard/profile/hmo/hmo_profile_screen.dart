...
class HMOProfileScreen extends StatelessWidget {
  const HMOProfileScreen({super.key});
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  profileContainer(
                    icon: AppImage.key,
                    isactive: model.getHmoIsActiveStatus(model),
                    text: 'KYC',
                  ...
                  profileContainer(
                    ...
                    bottomRight: 12,
                    text: 'Notifications',
                    // onTap: () => navigate.navigateTo(Routes.emptyNotification),
                  ),
