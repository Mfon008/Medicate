                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if(model.searchHospitalName!='')
                      ...model.getAllOfHospitalsResponseModel!.data!.hospitals!.where((w)=> w.name!.toLowerCase().contains(model.searchHospitalName.toLowerCase())).map(
                          (e) => Container(
                            width: double.infinity,
