...
class HealthCareDoctorSpecialistSignUpScreen extends StatefulWidget {
  ...
  @override
  State<HealthCareDoctorSpecialistSignUpScreen> createState() => _HealthCareDoctorSpecialistSignUpScreenState();
}

class _HealthCareDoctorSpecialistSignUpScreenState extends State<HealthCareDoctorSpecialistSignUpScreen> {
                ...
                ...areaExpertise.map(
                      (e) => Container(
                        ...
                        child: Row(
                          children: [
                            Container(
                              padding: widget.healthCareArea == e
                            ...
                            SizedBox(width: 10.w),
                            SizedBox(width: 230.w,child: TextView(
                              text: e,
                              maxLines: 2,
