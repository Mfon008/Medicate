...
class _HealthCareHospitalAndClinicSignUpScreenState
  ...
  TextEditingController healthCareTypeController = TextEditingController(text: 'Hospital');
                      ...
                      !isPassed(
                        ...
                        if (formKey.currentState!.validate()) {
                          model.signUpBusinessOwner(
                            context,
                            signUpEntity: SignUpHealthcareBusinessOwnerEntityModel(
                              registrationNumber: registrationNumberController.text.trim(),
                              phone: '+234${phoneController.text.trim()}',
                              healthcareProviderType: healthCareTypeController.text.trim().toUpperCase(),
