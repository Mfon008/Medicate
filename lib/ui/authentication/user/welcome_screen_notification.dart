...
class WelcomeScreenNotification extends StatefulWidget {
  WelcomeScreenNotification({super.key, this.phone});
  String? phone;

  @override
  State<WelcomeScreenNotification> createState() => _WelcomeScreenNotificationState();
}

class _WelcomeScreenNotificationState extends State<WelcomeScreenNotification> {
