...
class ManufacturerResetPinScreen extends StatefulWidget {
  ManufacturerResetPinScreen({super.key, this.phone, this.resetToken});
  String? phone;
  String? resetToken;

  @override
  State<ManufacturerResetPinScreen> createState() =>
