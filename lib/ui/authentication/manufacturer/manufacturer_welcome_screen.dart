...
ManufacturerWelcomeScreen({super.key, this.phone});
  ...
  @override
  State<ManufacturerWelcomeScreen> createState() =>
      _ManufacturerWelcomeScreenState();
}

class _ManufacturerWelcomeScreenState extends State<ManufacturerWelcomeScreen> {
